...
namespace NativeWeb
{
  ...
  public static extern void webkit_web_process_extension_initialize_with_user_data (WebKit.WebProcessExtension extension, [CCode (type = "const GVariant*")] GLib.Variant user_data);
}